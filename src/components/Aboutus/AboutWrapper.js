            ...
            <Grid fluid className="aboutus-wrapper">
                    <Col md={8} mdOffset={2}>
                        <Fade bottom>
                                ...
                                <Row className="about-text-wrapper">
                                    ...
                                    <Col md={6} className="about-img">
                                        <img src="africapolis/assets/images/swac-oecd.png" height="10%"
                                        alt="Africapolis Visualise Urbanisation in Africa"/>
                                        <br/>
                                        <img src="africapolis/assets/images/e-geopolis.png" height="10%"
                                        alt="Africapolis Visualise Urbanisation in Africa"/>
                                        <br/><br/><br/><br/><br/>
                                        <img src="africapolis/assets/images/SDG-11.png" height="5%"
                                        alt="Africapolis Visualise Urbanisation in Africa"/>
                        ...
                        <Fade bottom className="lastfade">
                            <Row className="logo-wrapper">
                                <Col md={2} className="logo"><Paper square={true} className="logopaper">
                                        <div className="logoitems">
                                            <img src="africapolis/assets/images/austria.jpg" width="70%"
                                                alt="Africapolis Visualise Urbanisation in Africa"/>
                                        </div>
                                </Paper></Col>
                                <Col md={2} className="logo"><Paper square={true} className="logopaper">
                                    <div className="logoitems">
                                        <img src="africapolis/assets/images/belgium.png" width="70%"
                                                alt="Africapolis Visualise Urbanisation in Africa"/>
                                    </div>
                                </Paper></Col>
                                <Col md={2} className="logo"><Paper square={true} className="logopaper">
                                    <div className="logoitems">
                                        <img src="africapolis/assets/images/canada.png" width="70%"
                                            alt="Africapolis Visualise Urbanisation in Africa"/>
                                    </div>
                                </Paper></Col>
                                <Col md={2} className="logo"><Paper square={true} className="logopaper">
                                <div className="logoitems"><img src="africapolis/assets/images/cliss.jpg" height="50%"
                                        alt="Africapolis Visualise Urbanisation in Africa"/>
                                        </div>
                                </Paper></Col>
                            </Row>
                            <Row className="logo-wrapper">
                                <Col md={2} className="logo"><Paper square={true} className="logopaper">
                                <div className="logoitems"> <img src="africapolis/assets/images/ECOWAS.jpg" height="50%"
                                        alt="Africapolis Visualise Urbanisation in Africa"/>
                                        </div>
                                </Paper></Col>
                                <Col md={2} className="logo"><Paper square={true} className="logopaper">
                                <div className="logoitems"><img src="africapolis/assets/images/EU.jpg" height="40%"
                                        alt="Africapolis Visualise Urbanisation in Africa"/>
                                        </div>
                                </Paper></Col>
                                <Col md={2} className="logo"><Paper square={true} className="logopaper">
                                <div className="logoitems"><img src="africapolis/assets/images/france.jpg" height="30%"
                                        alt="Africapolis Visualise Urbanisation in Africa"/>
                                        </div></Paper></Col>
                                        <Col md={2} className="logo"><Paper square={true} className="logopaper">
                                        <div className="logoitems">
                                        <img src="africapolis/assets/images/lux.png" height="25%"
                                              alt="Africapolis Visualise Urbanisation in Africa"/>
                            ...
                            <Row className="logo-wrapper addmargin">
                                  <Col md={2} className="logo"><Paper square={true} className="logopaper">
                                  <div className="logoitems">
                                  <img src="africapolis/assets/images/netherlands.jpg" height="30%"
                                    alt="Africapolis Visualise Urbanisation in Africa"/>
                                    </div>
                                </Paper></Col>

                                <Col md={2} className="logo"><Paper square={true} className="logopaper">
                                <div className="logoitems"><img src="africapolis/assets/images/switzerland.png" height="30%"
                                        alt="Africapolis Visualise Urbanisation in Africa"/>
                                        </div>
                                </Paper></Col>
                                <Col md={2} className="logo"><Paper square={true} className="logopaper">
                                <div className="logoitems"><img src="africapolis/assets/images/UEMOA.jpg" height="40%"
                                        alt="Africapolis Visualise Urbanisation in Africa"/>
                                        </div></Paper></Col>
                                <Col md={2} className="logo"><Paper square={true} className="logopaper">
                                    <div className="logoitems">
                                    <img src="africapolis/assets/images/US.png" height="30%"
                                            alt="Africapolis Visualise Urbanisation in Africa"/>
                                    </div>
                                </Paper></Col>
                            </Row>
