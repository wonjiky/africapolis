...
var validateSharedProps = function validateSharedProps(_ref5) {
  ...
  if (process.env.NODE_ENV !== 'production') {
    if (typeof children !== 'function') {
      throw Error('An invalid "children" prop has been specified. ' + 'Value should be a function that creates a React element. ' + ("\"" + (children === null ? 'null' : typeof children) + "\" was specified."));
    }
